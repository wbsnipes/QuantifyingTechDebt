...
\begin{itemize}
    ...
    \Fix{Will:why not add complexity?}
...
Aligning the two data sources at the class level allows us to ask questions of the intersected data set. For example we could investigate in future research results, the impact of code smells~\cite{Fowler_etal:1999} on interest payments. Questions\ldots\Fix{TODO(Will)}
...
By defining the measurement framework, the calculation of interest payments on \TD related to code structure will depend on understanding the correlation between code structural metrics and code comprehension effort metrics described herein.  The study of this correlation is the objective of applying this framework in future research.
