...
Aligning the two data sources at the class level allows us to ask questions of the intersected data set. For example we could investigate in future research results, the impact of code smells~\cite{Fowler_etal:1999} on interest payments. 
