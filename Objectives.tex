...
Aligning the two data sources at the class level allows us to ask questions of the intersected data set. For example, we could investigate the impact of code smells~\cite{Fowler_etal:1999} on interest payments. Questions\ldots\Fix{TODO(Will)}
We can investigate how much the magnitude of the Feature Envy smell as measured by $Class Coupled$ affects $\# Other Class Accesses$ and $Time Spent in Other Classes$ measures of comprehension effort.  
